...
export const technologies = {
    ...
    VueJs: { name: "VueJs", icon: icons.vuejs, order: 4 },
    Docker: { name: "Docker", icon: icons.docker, order: 5 },
    GitHub: { name: "GitHub", icon: icons.github, order: 6 },
    PostgreSQL: { name: "PostgreSQL", icon: icons.postgresql, order: 7 },
    React: { name: "React", icon: icons.react, order: 8 },
